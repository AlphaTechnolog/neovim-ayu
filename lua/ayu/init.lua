...
local function set_groups()
  local groups = {
    ...
    BlinkCmpMenuSelection = { bg = colors.selection_inactive },
    BlinkCmpScrollBarGutter = { bg = colors.line },
    BlinkCmpScrollBarThumb = { bg = colors.fg_idle },
    BlinkCmpLabel = { fg = colors.fg_idle },
    BlinkCmpLabelDeprecated = { fg = colors.comment, strikethrough = true },
    BlinkCmpLabelMatch = { fg = colors.keyword },
    ...
    BlinkCmpKindField = { fg = colors.tag },
    BlinkCmpKindVariable = { fg = colors.markup },
    ...
    BlinkCmpKindEnumMember = { fg = colors.regexp },
    ...
    BlinkCmpKindTypeParameter = { fg = colors.lsp_parameter },
...
function ayu.colorscheme()
  ...
  colors:apply_overrides(config.palette or {})
